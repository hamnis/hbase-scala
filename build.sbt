...
libraryDependencies += ExcludeAllTransitiveDeps(target.value, "org.apache.hbase" % "hbase" % "0.94.16")

libraryDependencies += ExcludeAllTransitiveDeps(target.value, "org.apache.hadoop" % "hadoop-core" % "1.0.4")
...
libraryDependencies += ExcludeAllTransitiveDeps(target.value, "org.apache.zookeeper" % "zookeeper" % "3.4.5")
